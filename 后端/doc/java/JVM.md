...
![image-20220127173155156](https://gitee.com/Sean0516/image/raw/master/img/image-20220127173155156.png)
...
- Java的SPI，发起者是BootstrapClassLoader，BootstrapClassLoader已经是最上层的了。它直接获取了AppClassLoader进行驱动加载，和双亲委派是相反的
